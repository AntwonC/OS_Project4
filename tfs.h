...
#define MAX_DNUM 16384 //TODO figure out what this is
...
struct inode {
	...
	uint32_t	size;				/* size of the file */					// the size unit is blocks
	uint32_t	type;				/* type of the file */
	uint32_t	link;				/* link count */						//TODO isn't this in stat?
